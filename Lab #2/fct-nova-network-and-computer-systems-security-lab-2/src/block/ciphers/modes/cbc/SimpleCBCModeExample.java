...
/**
 * Class responsible for Simple CBC Mode Example.
 * 
 * Description:
 ...
 *   with CBC Mode, {some-padding} and Secret Key of 256-bit size;
 */
public class SimpleCBCModeExample {
	...
	public static void main(String[] args) throws Exception {
        ...
        byte[] initialisingVectorBytes = new byte[] { 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01, 0x00, 
