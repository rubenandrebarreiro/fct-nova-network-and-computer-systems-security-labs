...
/**
 * Class responsible for Simple Tampering Attack Example 1.
 * 
 * Description:
 * - A simple and basic class and respectively, program, to show an example of
 *   a Tampering Active Attack;
 */
public class SimpleTamperingAttackExample1 {
	...
	public static void main(String[] args) throws Exception {
        ...
        // The De-cryption process made by Bob and the de-ciphering of its respectively content
