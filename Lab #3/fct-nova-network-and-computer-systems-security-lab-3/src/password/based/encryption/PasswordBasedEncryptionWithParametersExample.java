...
/**
 * Class responsible for Password Based Encryption With Parameters Example.
 * 
 * Description:
 * - A simple and basic class and respectively, program, to show an example of
 *   how to use a process of Password Based Encryption with parameters,
 *   using SHA and 3 Key Triple DES (Triple Data Encryption Standard);
 */
public class PasswordBasedEncryptionWithParametersExample {
	
	/**
	 * Main method. Performs a Password Based Encryption with parameters,
	 * using SHA and 3 Key Triple DES (Triple Data Encryption Standard).
	 * 
